...
- [ ] Browser open at **http://localhost:5173** (or LAN IP) — scenario cards visible, no errors
...
- [ ] If demo fails mid-run: refresh browser, re-select scenario, continue from Step 2
...
**Action:** Screen shows the scenario selector with three cards — no scenario selected yet.
...
2. The page resets and loads the infliximab claim
3. Run through Steps 1–5 again — the architecture is identical, the clinical situation is different
...
2. The page resets and loads the GLP-1 semaglutide claim
3. Run through Steps 1–5 again
